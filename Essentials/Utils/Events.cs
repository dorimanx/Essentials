...
namespace Essentials.Utils
{
    public static class Events
    {
        ...
        public static void RaiseEvent<T1>(T1 instance, MethodInfo method, EndpointId target = default) where T1 : IMyEventOwner
        {
        ...
        public static void RaiseEvent<T1, T2>(T1 instance, MethodInfo method, T2 arg1, EndpointId target = default) where T1 : IMyEventOwner
        {
        ...
        public static void RaiseEvent<T1, T2, T3>(T1 instance, MethodInfo method, T2 arg1, T3 arg2, EndpointId target = default) where T1 : IMyEventOwner
        {
        ...
        public static void RaiseEvent<T1, T2, T3, T4>(T1 instance, MethodInfo method, T2 arg1, T3 arg2, T4 arg3, EndpointId target = default) where T1 : IMyEventOwner
        {
        ...
        public static void RaiseEvent<T1, T2, T3, T4, T5>(T1 instance, MethodInfo method, T2 arg1, T3 arg2, T4 arg3, T5 arg4, EndpointId target = default) where T1 : IMyEventOwner
        {
        ...
        public static void RaiseEvent<T1, T2, T3, T4, T5, T6>(T1 instance, MethodInfo method, T2 arg1, T3 arg2, T4 arg3, T5 arg4, T6 arg5, EndpointId target = default) where T1 : IMyEventOwner
        {
        ...
        public static void RaiseEvent<T1, T2, T3, T4, T5, T6, T7>(T1 instance, MethodInfo method, T2 arg1, T3 arg2, T4 arg3, T5 arg4, T6 arg5, T7 arg6, EndpointId target = default) where T1 : IMyEventOwner
        {
        ...
        public static void RaiseStaticEvent(MethodInfo method, EndpointId target = default, Vector3D? position = null)
        {
        ...
        public static void RaiseStaticEvent<T1, T2>(MethodInfo method, T1 arg1, T2 arg2, EndpointId target = default, Vector3D? position = null)
        {
        ...
        public static void RaiseStaticEvent<T1, T2, T3>(MethodInfo method, T1 arg1, T2 arg2, T3 arg3, EndpointId target = default, Vector3D? position = null)
        {
        ...
        public static void RaiseStaticEvent<T1, T2, T3, T4>(MethodInfo method, T1 arg1, T2 arg2, T3 arg3, T4 arg4, EndpointId target = default, Vector3D? position = null)
        {
        ...
        public static void RaiseStaticEvent<T1, T2, T3, T4, T5>(MethodInfo method, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, EndpointId target = default, Vector3D? position = null)
        {
        ...
        public static void RaiseStaticEvent<T1, T2, T3, T4, T5, T6>(MethodInfo method, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, EndpointId target = default, Vector3D? position = null)
        {
